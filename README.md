...
For source-based Docker Compose troubleshooting notes (including MinIO healthchecks and Vespa recovery), see [deployment/docker_compose/README.md](deployment/docker_compose/README.md).
