...
const MemoizedAppSidebarInner = memo(
  ({ folded, onFoldClick }: AppSidebarInnerProps) => {
    ...
    // Check if StarwoodGPT Craft is enabled via settings (backed by PostHog feature flag)
    ...
    // Find build_mode feature announcement notification (only if StarwoodGPT Craft is enabled)
