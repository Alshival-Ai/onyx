...
interface GeminiOnboardingFormProps {
...
function GeminiFormFields(props: OnboardingFormChildProps<GeminiFormValues>) {
          ...
          <FormField name={FIELD_API_KEY} state={state} className="w-full">
            ...
            {showApiMessage && (
              <FormField.APIMessage
                state={apiStatus}
                messages={{
                  loading: "Checking API key with Gemini...",
      ...
      <FormikField<string>
        ...
        render={(field, helper, meta, state) => (
          ...
          >
            ...
            <FormField.Message
              messages={{
                idle: "This model will be used by StarwoodGPT by default.",
                error: meta.error,
              }}
            />
          </FormField>
...
export function GeminiOnboardingForm({
  llmDescriptor,
  onboardingState,
  onboardingActions,
  open,
  onOpenChange,
}: GeminiOnboardingFormProps) {
  ...
  return (
    <OnboardingFormWrapper<GeminiFormValues>
      icon={icon}
      title="Set up Gemini"
